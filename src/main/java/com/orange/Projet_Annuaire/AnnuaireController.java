...
public class AnnuaireController {
	...
	public ResponseEntity<?> removeOne(@PathVariable int id) {
		if (ds.getFromId(id) == null) {
			return new ResponseEntity<>("Rien à supprimer", HttpStatus.NOT_FOUND);
		}
		ds.deleteFromId(id);
